              ...
              >
                <div className="pr-12">
                  ...
                  <p className="mt-4 text-lg text-gray-300">
                    This is an example of an efficient waste management system
                    you can implement using our solutions. It features
                    innovative tools and techniques designed to simplify your
                    waste collection, tracking, and disposal processes.
                  </p>
                </div>
              </animated.div>
            </div>
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-gray-600">
                      Our garbage management service ensures timely and
                      efficient waste collection. We utilize a fleet of modern
                      vehicles equipped with GPS tracking to optimize routes
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                ...
                <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700">
                  Ensure effective waste disposal by using our advanced
                  solutions. Our tools are designed to simplify the process and
                  improve efficiency, keeping your environment clean and
                  sustainable.
                </p>
                <p className="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-700">
                  Our system comes with ready-to-use features that help you
                  manage waste better and faster. Just customize the options to
                  fit your needs, and you're set to go. Streamline your
                  operations with smart waste tracking and collection tools.
                </p>
              </div>
                ...
                <div className="relative flex flex-col min-w-0 break-words  w-full mb-6 shadow-lg rounded-lg bg-green-600">
                  ...
                  <blockquote className="relative p-8 mb-4">
                    ...
                    <p className="text-md font-light mt-2 text-white">
                      Waste generation is a constant process, but with efficient
                      systems in place, we can manage its collection and
                      disposal year-round, ensuring a cleaner environment for
                      all.
                    </p>
                  </blockquote>
                </div>
              ...
              <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
                <div className="md:pr-12">
                  ...
                  <p className="mt-4 text-lg leading-relaxed text-black">
                    Our waste management solutions are designed to help you
                    transition to more sustainable practices. Whether you're a
                    small business or a large organization, we've got the tools
                    to help you succeed.
                  </p>
            ...
            <div className="flex flex-wrap justify-center text-center mb-24">
              <div className="w-full lg:w-6/12 px-4">
                ...
                <p className="text-lg leading-relaxed m-4 text-black">
                  According to the Environmental Protection Agency, waste
                  management professionals like Jane Doe are taking the lead in
